    ...
    <main className="min-h-screen bg-stone-950 px-6 py-16 text-stone-50">
      <article className="mx-auto flex max-w-4xl flex-col gap-8">
        <header className="space-y-4">
          ...
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-emerald-300">Methodology</p>
        ...
        <section className="rounded-3xl border border-stone-800 bg-stone-900 p-6">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-stone-300">
            {sources.map((source) => (
              <li key={source.href}>
                <a className="text-emerald-200 underline underline-offset-4" href={source.href} rel="noopener noreferrer" target="_blank">
                  {source.label}
                </a>
              </li>
            ))}
