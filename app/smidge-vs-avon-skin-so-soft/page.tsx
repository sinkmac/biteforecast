      ...
      <article className="mx-auto flex max-w-4xl flex-col gap-8">
              ...
              <tbody>
                {[
                  ...
                  <tr key={factor} className="border-b border-stone-800 align-top">
                    ...
                    <td className="py-4 pr-4 text-stone-300">{smidge}</td>
                    <td className="py-4 text-stone-300">{avon}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="rounded-2xl border border-emerald-400/30 bg-emerald-500/10 p-6">
          <p className="text-stone-100/90">
            ...
            <Link className="text-emerald-200 underline decoration-emerald-400/60 underline-offset-4" href="/scotland/glencoe-midges">
