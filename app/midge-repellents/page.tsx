        ...
        <section className="grid gap-6 md:grid-cols-2">
          ...
          <div className="border border-almanac-border bg-almanac-card p-6">
            ...
            <div className="mt-4 space-y-3 text-almanac-secondary">
              ...
              <p>Use the <Link className="text-almanac-green underline-offset-4 hover:underline" href="/midge-wind-watch">live calculator</Link> before settling into a calm evening spot, especially if there is damp ground, tree cover, or still water nearby.</p>
            </div>
          </div>
        </section>
